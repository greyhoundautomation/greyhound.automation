...
public class CanadaSite extends BasePage {
	...
	public void canadaBookAtrip() throws InterruptedException {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//div/ul/li[2]/a[@id='services' and @title='Services & Routes']")))
				.click();

		// Thread.sleep(3000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='sarBoxBot1'] [text()='Book Now']")))
				.click();
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div/ul/li[1][text()='Alberta']"))).click();
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath("//*[@id='ctl00_body_listOrigin_DropDown']/div/ul/li[text()='Red Deer']")).click();
